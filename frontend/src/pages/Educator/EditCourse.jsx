      ...
      <div className='bg-gray-50 p-6 rounded-md'>
        ...
        <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
          ...
          <div>
            ...
            <textarea id='des' type="text" className='w-full border px-4 py-2 rounded-md h-24 resize-none' placeholder='Course Description ' onChange={(e)=>setDescription(e.target.value)} value={description}   ></textarea>
          </div>
